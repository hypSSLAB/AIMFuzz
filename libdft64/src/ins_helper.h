...
#define M_CALL_R(fn)                                                           \
  INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                 IARG_THREAD_ID, IARG_MEMORYREAD_EA, IARG_INST_PTR, IARG_END)  \

#define M_CALL_R_POP(fn)                                                       \
  INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                 IARG_THREAD_ID, IARG_MEMORYWRITE_EA, IARG_INST_PTR, IARG_END)

#define M_CALL_W_PUSH(fn)                                                      \
  INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                 IARG_THREAD_ID, IARG_MEMORYWRITE_EA, IARG_INST_PTR, IARG_END)                 
...
#define R2R_CALL(fn, dst, src)                                                 \
  INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                 ...
                 REG_INDX(src), IARG_INST_PTR, IARG_CONST_CONTEXT, IARG_END)


// Don't need to check
#define R2R_CALL_XFER(fn, dst, src)                                                 \
  INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                 IARG_THREAD_ID, IARG_UINT32, REG_INDX(dst), IARG_UINT32,      \
                 REG_INDX(src), IARG_INST_PTR, IARG_CONST_CONTEXT,             \
                 IARG_UINT32, src, IARG_END)
...
#define M2R_CALL(fn, dst)                                                      \
  INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                 IARG_THREAD_ID, IARG_UINT32, REG_INDX(dst),                   \
                 IARG_MEMORYREAD_EA, IARG_INST_PTR, IARG_CONST_CONTEXT, IARG_END);

#define R2M_CALL_XFER(fn, src)                                                      \
  INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                 IARG_THREAD_ID, IARG_MEMORYWRITE_EA, IARG_UINT32,             \
                 REG_INDX(src), IARG_INST_PTR, IARG_CONST_CONTEXT, IARG_UINT32, src, IARG_END);
